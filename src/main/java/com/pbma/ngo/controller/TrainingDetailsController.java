...
public class TrainingDetailsController {
	...
	@GetMapping(value = "/trainees/{traineeId}/trainings", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PutMapping(value = "/trainees/{traineeId}/trainings/{trainingId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> editTrainingDetails(@PathVariable("traineeId") Long traineeId,@PathVariable("trainingId") long trainingId, @RequestBody String trainingDetailsRequest) throws Exception {
		trainingDetailsLogger.info("Received request to Edit Training Details");
		ResponseEntity<String> responseEntity = trainingDetailsService.updateTrainingDetails(traineeId,trainingId, trainingDetailsRequest);
		trainingDetailsLogger.info("Completed request to Edit Training Details");
		return responseEntity;
	}
